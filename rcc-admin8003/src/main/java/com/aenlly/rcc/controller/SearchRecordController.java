...
import com.aenlly.rcc.service.ISearchRecordService;
...
public class SearchRecordController {
  ...
  public CommonResult<IPage<SearchUser>> getList(
      ...
      @ApiParam("查询的搜索类型(非必须)") @RequestParam(value = "type", required = false)
  ...
  @ApiOperation(value = "获取搜索记录图表型数据")

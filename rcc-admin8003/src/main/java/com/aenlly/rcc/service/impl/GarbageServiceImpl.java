...
public class GarbageServiceImpl extends ServiceImpl<GarbageMapper, Garbage>
  ...
  public String uploadVideo(MultipartFile file) {
    return uploadService.uploadVideo(file, UploadPathNameEnum.GARBAGE_IMAGE_NAME);
  }
  ...
  public String uploadImage(MultipartFile file) {
    return uploadService.uploadImage(file, UploadPathNameEnum.GARBAGE_VIDEO_NAME);
  }

...
public class QueryWrapperUtil {
    ...
    public static Wrapper<Garbage> queryByGarbageType(String garbageType) {
        ...
        wrapper.select("garbage_id", "video_url", "garbage_type", "name_cn", "name_en", "img_url", "text_title", "text_desc", "bg_color")
    ...
    public static Wrapper<GarbageList> queryByGarbageId(Integer garbageId) {
        ...
        wrapper.select("id", "garbage_name", "img_url")
               .eq("garbage_id", garbageId)
               .orderByDesc(UPDATE_TIME_FILED);
        return wrapper;
    }
    ...
    /**
     ...
     @return 查询对象
     */
    public static Wrapper<LikeEntity> getIsLikeByUserId(String userId, String entityName, String dataId) {
        QueryWrapper<LikeEntity> wrapper = new QueryWrapper<>();
        wrapper.select("like_id")
               .eq("user_id", userId)
               .eq("entity_name", entityName)
    ...
    /**
     ...
     @return 查询对象
     */
    public static Wrapper<CollectEntity> getIsCollectByUserId(String userId, String entityName, String dataId) {
        QueryWrapper<CollectEntity> wrapper = new QueryWrapper<>();
        wrapper.select("collect_id")
               .eq("user_id", userId)
               .eq("entity_name", entityName)
    ...
    public static Wrapper<VideoUserView> getByChekTop() {
        ...
        wrapper.select("video_url")
               .eq("video_check", VideoCheckEnum.TOP);
        return wrapper;
    }
    ...
    /**
     ...
     @return 查询对象
     */
    public static Wrapper<CollectEntity> getUserCollectListBy(String userId, String name, String entityName) {
        QueryWrapper<CollectEntity> wrapper = new QueryWrapper<>();
        wrapper.select("collect_id", "data_title", "data_desc", "data_id", "img_url", "entity_name", "text_tag")
               .eq("user_id", userId)

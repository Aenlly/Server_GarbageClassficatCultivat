...
public class WasteTurnTreasureWrapperUtil {
    ...
    /**
     ...
     @return 查询对象
     */
    public static Wrapper<WasteTurnTreasureVo> queryListPage(QueryWasteTypeEnum queryType, String text, WasteTagEnum textTag, IsUserUploadEnum isUserUploadEnum, List<AuditEnum> auditEnums) {

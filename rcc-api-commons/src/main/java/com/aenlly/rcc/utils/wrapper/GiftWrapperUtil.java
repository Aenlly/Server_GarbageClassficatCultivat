...
public class GiftWrapperUtil {
     ...
     */
    public static Wrapper<GiftListView> queryListPage(QueryGiftTypeEnum queryType, String text, Long typeId) {
    ...
    public static Wrapper<GiftListView> getUserGiftList(String name, Integer type) {
        QueryWrapper<GiftListView> wrapper = new QueryWrapper<>();
        wrapper.select("gift_id", "gift_name", IMG_URL_FILED, "point", "price")
               .like("gift_name", name)
